...
class printing_printer(orm.Model):
    ...
    _columns = {
        ...
        'status': fields.selection([('unavailable','Unavailable'),('printing','Printing'),('unknown','Unknown'),('available','Available'),('error','Error'),('server-error','Server Error')], 'Status', required=True, readonly=False),
        'status_message': fields.char('Status Message', size=500, readonly=False),
        'model': fields.char('Model', size=500, readonly=False),
        'location': fields.char('Location', size=500, readonly=False),
        'uri': fields.char('URI', size=500, readonly=False),
        }
