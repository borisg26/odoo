...
class PrestaShopWebService(object):
    ...
    MAX_COMPATIBLE_VERSION = '1.6.5.0'
    ...
    def edit(self, resource, content,id):
        """
        Edit (PUT) a resource.
        ...
        full_url = "%s%s/%s" % (self._api_url, resource, id)
        return self.edit_with_url(full_url, content)
...
if __name__ == '__main__':
    prestashop = PrestaShopWebServiceDict('http://127.0.0.1/prestashop/',
                                          'P9CZWT1AATV8QIINOGWD7T8WXT22NJIU')
    ...
    product_data['product']['reference'] = 'Denis'
    prestashop.edit('products', 1, product_data)
